...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1",h1 style="color:white"  >Department of Computing and Information Systems</h1></a>
      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <h6 class="dropdown-header">Year:</h6>
            <a class="dropdown-item" href="{{url('first')}}">First Year</a>
...
<ol class="breadcrumb navbar-dark bg-dark">
            <li class="breadcrumb-item ">
              ...
              <h2 style="color:blue">Wellcome</h2>
            </li>
            <style>
          html{
